...
messages.Add(new SystemChatMessage("Sos un asistente de cocina, quiero que me ofrezcas un plato a realizar con su receta con los ingredientes que te de a continuacion."));
